...
-(void)draw{
    ...
    logo.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:_xuan.logoUrl]]];
...
//    self.company.backgroundColor = [UIColor blueColor];
    ...
    //学校简称
    self.universityShortName.frame = CGRectMake(105, 42.5, 60, 15);
//    self.universityShortName.backgroundColor= [UIColor orangeColor];
    
    //地址
    self.address.frame = CGRectMake(185, 42.5, self.contentView.frame.size.width-150, 15);
